 ...
 *
 */
public class SQLXMLValueParameter extends ValueParameter<SQLXML> {

	/**
	 * @param value
	 */
	public SQLXMLValueParameter(SQLXML value) {
		super(value);
	...
	protected void setInternally(int parameterIndex, PreparedStatement ps) throws SQLException {
		...
		ps.setSQLXML(parameterIndex, value);
	}
	...
	protected void setInternally(String parameterName, CallableStatement statement) throws SQLException {
		// TODO Auto-generated method stub
		statement.setSQLXML(parameterName, value);
	}
}
