 ...
 *
 */
public class BigDecimalValueParameter extends ValueParameter<BigDecimal> {

	/**
	 * @param value
	 */
	public BigDecimalValueParameter(BigDecimal value) {
		super(value);
	...
	protected void setInternally(String parameterName, CallableStatement statement) throws SQLException {
		// TODO Auto-generated method stub
		statement.setBigDecimal(parameterName, value);
	}
}
