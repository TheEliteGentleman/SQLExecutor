 ...
 *
 */
public class ArrayValueParameter extends ValueParameter<Array> {

	/**
	 * @param value
	 */
	public ArrayValueParameter(Array value) {
		super(value);
	...
	protected void setInternally(String parameterName, CallableStatement statement) throws SQLException {
		// TODO Auto-generated method stub
		throw new UnsupportedOperationException("Method CallableStatement.setArray(String, Array) doesn't exist.");
	}
}
