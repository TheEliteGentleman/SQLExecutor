...
public interface AsyncSQLQueryExecutor extends SQLExecutor {
	...
	public <T> Future<T> executeQuery(final String query, final Parameters parameter, final ResultSetHandler<T> handler) throws DatabaseExecutionException;
	...
	public Future<Integer> executeUpdate(final String query, final Parameters parameter) throws DatabaseExecutionException;
