 ...
 *
 */
public class RowIdValueParameter extends ValueParameter<RowId> {

	/**
	 * @param value
	 */
	public RowIdValueParameter(RowId value) {
		super(value);
	...
	protected void setInternally(int parameterIndex, PreparedStatement ps) throws SQLException {
		...
		ps.setRowId(parameterIndex, value);
	}
	...
	protected void setInternally(String parameterName, CallableStatement statement) throws SQLException {
		// TODO Auto-generated method stub
		statement.setRowId(parameterName, value);
	}
}
